<?php
  ...
  return array(
	...
	'edit default user preferences' => 'Edit default user preferences',
  	...
  	'user ws config option name drag_drop_prompt' => 'Action to take on drag and drop to dimension member',
  	'user ws config option desc drag_drop_prompt' => 'Choose which action should be taken when dragging an object to a dimension member.',
