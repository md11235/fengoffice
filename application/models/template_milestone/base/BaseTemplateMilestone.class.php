<?php
  ...
  /**
  * BaseTemplateMilestone class
  *
  * 
  */
  abstract class BaseTemplateMilestone extends ContentDataObject {
    ...
    */
    function manager() {
      if(!($this->manager instanceof TemplateMilestones)) $this->manager = TemplateMilestones::instance();
      return $this->manager;
    } // manager
  
 } // BaseTemplateMilestone 
